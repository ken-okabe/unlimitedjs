...
Unlike the other virtual DOM frameworks, **unlimitejs** works directly with https://material.io/develop/web/[Material Design Components(MDC) for web] in the standarized manner without the need for a wrapper/adapter/component libraly such as https://github.com/material-components/material-components-web-react[MDC React] or https://github.com/stasson/vue-mdc-adapter[vue-mdc-adapter]
...
.JSX(TSX) Code
====
https://github.com/stken2050/unlimitedjs/blob/master/unlimitedjs-materialdesign/src/hello.tsx[source]
==== 
