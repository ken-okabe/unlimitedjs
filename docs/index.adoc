...
unlimitejs works with https://material.io/develop/web/[Material Design Components(MDC) for web] in the standarized way without the need for a wrapper/adapter/libraly such as https://github.com/material-components/material-components-web-react[MDC React] or https://github.com/stasson/vue-mdc-adapter[/vue-mdc-adapter]
